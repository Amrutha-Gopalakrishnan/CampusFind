...
from analysis import get_past_analysis       # Your existing 150-row dashboard
from ml_analysis import get_ml_analysis      # New 300-row ML dataset
...
@app.get("/ml-analysis")
def ml_analysis():
    """Return analysis JSON for ML Predict page"""
    data = get_ml_analysis()
    return data
