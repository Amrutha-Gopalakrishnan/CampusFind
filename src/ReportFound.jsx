        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6">
            ...
            <button
              type="submit"
              disabled={uploading}
              className={`flex-1 px-6 py-3 text-white bg-gradient-to-r from-blue-700 via-indigo-600 to-cyan-500 shadow-lg  rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 ${
